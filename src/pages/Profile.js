...
const Profile = () => {
  ...
  return (
    <>
      ...
      <Container class1=" home-wrapper-2 border border-primary d-flex justify-content-center align-items-center py-5">
        <div>
          <div className='row'>
            <div className='col-12'>
              <div className='d-flex justify-content-center' >
                <h3 className='my-3 text-primary '>Update Profile</h3>
              </div>
